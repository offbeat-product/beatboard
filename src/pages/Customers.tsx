            ...
            <div className="bg-card rounded-lg shadow-sm p-5 animate-fade-in" style={{ animationDelay: "150ms" }}>
              ...
              <ResponsiveContainer width="100%" height={280}>
                <ComposedChart data={chartData}>
                  ...
                  <Legend />
                  <ReferenceLine yAxisId="left" y={avgCustomerUnitPrice} stroke="hsl(var(--destructive))" strokeDasharray="6 3" strokeWidth={1.5} label={{ value: `平均 ${avgCustomerUnitPrice.toLocaleString()}${unitSuffix}`, position: "insideTopLeft", offset: 10, fontSize: 11, fontWeight: 600, fill: "hsl(var(--destructive))" }} />
